 ...
 * @Last Modified by: 史涛
 * @Last Modified time: 2019-12-30 15:40:15
 */
...
const SWITCHLAYERVISIABLE_CHANGE='SWITCHLAYERVISIABLE_CHANGE';
const COMPARELAYER_CHANGE='COMPARELAYER_CHANGE';
...
function switchLayerVisiable(layername){

    return {
        type: SWITCHLAYERVISIABLE_CHANGE,
        layername
    }
}
...
function changeCompareLayer(compare){
    return {
        type: COMPARELAYER_CHANGE,
        compare
    }
}
